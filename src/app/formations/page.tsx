    ...
    <div className="min-h-screen bg-[#0A0A0A] pt-24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {formations.map((f) => (
            <div key={f.titre} className="glass p-8 flex flex-col">
              <div className="text-xs tracking-widest uppercase text-[#C9A84C]/60 mb-2">
                {f.niveau} · {f.duree}
              </div>
              <h2
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 py-3 border border-[#C9A84C]/40 text-[#C9A84C] text-sm font-medium tracking-widest uppercase hover:bg-[#C9A84C]/10 hover:border-[#C9A84C] transition-all"
              >
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center glass p-12">
          ...
          <p className="text-[#FAFAFA]/50 text-sm mb-8">
