        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div>
              ...
              <h1
                className="text-5xl md:text-6xl font-bold text-[#1A1520] leading-tight mb-8"
              ...
              <div className="space-y-6 mb-12">
                {[
                  ...
                  <div key={item.label} className="flex items-center gap-6">
                    <div className="w-px h-8 bg-[#C4A5B5]/40" />
                    <div>
                      <div className="text-[10px] tracking-[0.3em] uppercase text-[#C4A5B5]/60 mb-0.5">
                        {item.label}
                      </div>
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-sm text-[#1A1520]/70 hover:text-[#C4A5B5] transition-colors"
                        >
                          {item.value}
                        </a>
                      ) : (
                        <span className="text-sm text-[#1A1520]/70">{item.value}</span>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="glass p-6 space-y-3">
                <div className="text-xs tracking-[0.3em] uppercase text-[#C4A5B5]/60 mb-4">
                  Nos engagements
                </div>
                {[
                  ...
                  <div key={g} className="flex items-center gap-3 text-sm text-[#1A1520]/50">
                    <div className="w-1 h-1 bg-[#C4A5B5] rounded-full flex-shrink-0" />
                    {g}
                  </div>
                ))}
              </div>
