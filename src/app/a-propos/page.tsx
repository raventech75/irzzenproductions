      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-[#FAFAFA]/50 text-lg leading-relaxed mb-6 font-light">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#C9A84C] text-[#0A0A0A] text-sm font-semibold tracking-[0.2em] uppercase hover:bg-[#E8C96A] transition-colors gold-glow"
            >
              Travailler avec nous <ArrowRight size={14} />
            </Link>
          </div>
          <div className="aspect-square bg-[#111111] border border-[#C9A84C]/10 flex items-center justify-center text-[#C9A84C]/20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="text-center glass p-8">
                ...
                <div className="text-xs tracking-[0.3em] uppercase text-[#FAFAFA]/40">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.5em] uppercase text-[#C9A84C] mb-4">Ce qui nous guide</p>
            <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {valeurs.map((v) => (
              <div key={v.titre} className="glass p-8 flex gap-6">
                <div className="w-px bg-gradient-to-b from-[#C9A84C] to-transparent flex-shrink-0" />
                <div>
                  <h3
                  ...
                  <p className="text-sm text-[#FAFAFA]/50 leading-relaxed">{v.texte}</p>
                </div>
              </div>
            ))}
          </div>
