  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] pt-24">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-[#C9A84C]/3 blur-[200px] rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px]" />
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <p className="text-xs tracking-[0.5em] uppercase text-[#C9A84C] mb-4">
            Notre spécialité
          </p>
          <h1
            className="text-5xl md:text-7xl font-bold text-[#FAFAFA] leading-tight mb-8"
          ...
          <p className="text-[#FAFAFA]/50 text-xl max-w-2xl mx-auto font-light mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/tarifs"
              className="px-10 py-4 bg-[#C9A84C] text-[#0A0A0A] text-sm font-semibold tracking-[0.2em] uppercase hover:bg-[#E8C96A] transition-colors gold-glow"
            >
              Voir les formules
            </Link>
            <Link
              href="/galerie"
              className="px-10 py-4 border border-[#C9A84C]/40 text-[#FAFAFA]/80 text-sm font-light tracking-[0.2em] uppercase hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all"
            >
              Notre portfolio
            </Link>
          </div>
      ...
      <section id="photo" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            {/* Placeholder photo */}
            <div className="aspect-[4/5] bg-[#111111] border border-[#C9A84C]/10 flex items-center justify-center text-[#C9A84C]/20">
            ...
            <div>
              ...
              <h2
                className="text-4xl md:text-5xl font-bold text-[#FAFAFA] leading-tight mb-6"
                style={{ fontFamily: "var(--font-playfair)" }}
              >
                Des images qui{" "}
                <span className="text-gradient-gold italic">parlent</span>
              </h2>
              <p className="text-[#FAFAFA]/50 text-lg leading-relaxed mb-8 font-light">
              ...
              <ul className="space-y-3 mb-10">
                {photoInclus.map((item) => (
                  <li key={item} className="flex items-center gap-3 text-sm text-[#FAFAFA]/60">
              ...
              <Link
                href="/tarifs"
                className="inline-flex items-center gap-2 text-sm text-[#C9A84C] tracking-widest uppercase font-medium hover:gap-4 transition-all"
              >
          ...
          <div id="video" className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 aspect-[4/5] bg-[#111111] border border-[#C9A84C]/10 flex items-center justify-center text-[#C9A84C]/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={step.num} className="relative">
                <div
                  className="text-7xl font-bold text-[#C9A84C]/10 mb-4 leading-none"
                  style={{ fontFamily: "var(--font-playfair)" }}
                >
                  {step.num}
                </div>
                ...
                <p className="text-sm text-[#FAFAFA]/40 leading-relaxed">{step.texte}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.5em] uppercase text-[#C9A84C] mb-4">FAQ</p>
            <h2
              className="text-4xl md:text-5xl font-bold text-[#FAFAFA]"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
          ...
          <div className="space-y-4">
            {faq.map((item) => (
              <details
                key={item.q}
                className="group glass border border-[#C9A84C]/15 open:border-[#C9A84C]/40 transition-all"
              >
                <summary className="flex items-center justify-between px-6 py-5 cursor-pointer list-none text-[#FAFAFA] text-sm font-medium hover:text-[#C9A84C] transition-colors">
                  {item.q}
                  <span className="text-[#C9A84C]/60 group-open:rotate-45 transition-transform duration-300 text-xl leading-none flex-shrink-0 ml-4">
                    +
                  </span>
                </summary>
                <div className="px-6 pb-5 text-sm text-[#FAFAFA]/50 leading-relaxed border-t border-[#C9A84C]/10 pt-4">
                  {item.a}
                </div>
              </details>
            ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center glass p-16 relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-px bg-gradient-to-r from-transparent via-[#C9A84C] to-transparent" />
          <h2
          ...
          <p className="text-[#FAFAFA]/50 mb-10">
            Vérifiez nos disponibilités pour votre date et recevez votre devis
            personnalisé sous 24h.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-10 py-4 bg-[#C9A84C] text-[#0A0A0A] text-sm font-semibold tracking-[0.2em] uppercase hover:bg-[#E8C96A] transition-colors gold-glow"
          >
