  ...
  return (
    <section className="bg-[#FDFAF7] py-28">
      <div className="wrap">
        ...
        {services.map((s, i) => (
          <Reveal key={s.num} delay={i * 100} direction="up">
            <Link
              href={s.href}
            ...
            >
              ...
              <div className="ml-auto text-right shrink-0">
                <div className={`text-[13px] font-medium mb-1 ${s.priceColor}`}>{s.prix}</div>
