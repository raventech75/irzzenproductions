    ...
    <div className="grid lg:grid-cols-[1fr_360px] gap-8">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-semibold">Questionnaire</h1>
          <Stepper step={2} />
        </div>
        ...
        <Card className="p-5">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <input className="border rounded-xl px-3 py-2" placeholder="Téléphone" value={phone} onChange={e=>setPhone(e.target.value)} />
            <input className="border rounded-xl px-3 py-2" placeholder="Prénom" value={firstName} onChange={e=>setFirst(e.target.value)} />
            <input className="border rounded-xl px-3 py-2" placeholder="Nom" value={lastName} onChange={e=>setLast(e.target.value)} />
            <input className="border rounded-xl px-3 py-2 md:col-span-2" placeholder="Adresse postale" value={address} onChange={e=>setAddress(e.target.value)} />
          </div>
        </Card>
        ...
        <Card className="p-5">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <input className="border rounded-xl px-3 py-2" placeholder="Noms des mariés * (ex : Justine & Feridun)" value={couple} onChange={e=>setCouple(e.target.value)} />
            <input className="border rounded-xl px-3 py-2" type="date" placeholder="Date *" value={date} onChange={e=>setDate(e.target.value)} />
            <input className="border rounded-xl px-3 py-2" placeholder="Ville" value={city} onChange={e=>setCity(e.target.value)} />
            <input className="border rounded-xl px-3 py-2" placeholder="Lieu cérémonie" value={ceremony} onChange={e=>setCeremony(e.target.value)} />
            <input className="border rounded-xl px-3 py-2 md:col-span-2" placeholder="Lieu réception" value={reception} onChange={e=>setReception(e.target.value)} />
            <textarea className="border rounded-xl px-3 py-2 md:col-span-2" rows={5} placeholder="Souhaits / timing / personnes clés…" value={wishes} onChange={e=>setWishes(e.target.value)} />
          </div>
        </Card>
